...
@section('content')
    <div class="bg-white rounded-2xl border border-gray-100 p-6 md:p-8 shadow-sm max-w-2xl mx-auto">
        <div class="mb-8 pb-6 border-b border-gray-100">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-midnight-900 mt-1">New Category</h1>
        </div>
            ...
            <div>
                ...
                <div class="relative group">
                    ...
                    <label for="image" class="cursor-pointer block">
                        <div id="image-placeholder" class="w-full h-48 border-2 border-dashed border-gray-200 rounded-xl flex flex-col items-center justify-center group-hover:border-daraz-500 transition-colors bg-gray-50">
                            <i class="fas fa-image text-3xl text-gray-300 group-hover:text-daraz-500 mb-3 transition-colors"></i>
                            <span class="text-xs font-semibold text-gray-400 group-hover:text-daraz-600 transition-colors">Click to Upload Image</span>
                        </div>
                        <img id="image-preview" class="hidden w-full h-48 object-cover rounded-xl border border-gray-200">
                    </label>
                </div>
                @error('image')
                    <p class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</p>
